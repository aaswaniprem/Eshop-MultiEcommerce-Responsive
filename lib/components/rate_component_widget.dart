...
class RateComponentWidget extends StatefulWidget {
  const RateComponentWidget({Key? key}) : super(key: key);

  @override
  _RateComponentWidgetState createState() => _RateComponentWidgetState();
}
                          ...
                          child: RichText(
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text:
                                      'Protect+ with AppleCare Services for iPhone 13 (1 year) (Email Delivery, No Physical Kit)',
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)

...
class CustomerReviewsWidget extends StatefulWidget {
  const CustomerReviewsWidget({Key? key}) : super(key: key);
...
class _CustomerReviewsWidgetState extends State<CustomerReviewsWidget> {
  late CustomerReviewsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerReviewsModel());
  }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          'https://m.media-amazon.com/images/I/51cniYCa4uL._UC175,175_CACC,175,175_.jpg',
                          width: 300.0,
                          height: 300.0,
                          fit: BoxFit.cover,
                        ),
